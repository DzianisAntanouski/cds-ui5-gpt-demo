			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chatui-display": {
								"semanticObject": "chatui",
								"action": "display",
								"description": "A Fiori Chat GPT application.",
								"title": "Chat GPT",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chatui",
									"url": sap.ui.require.toUrl("chatui")
								}
							}
						}
					}
